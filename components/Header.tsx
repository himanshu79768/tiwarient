...
const Header: React.FC<HeaderProps> = ({ onMenuClick, onNavigate, currentPage }) => {
  ...
  // The header should be solid if it's NOT the home page,
  // OR if it IS the home page AND the user has scrolled.
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 h-24 z-40 flex items-center justify-between px-6 md:px-12 transition-all duration-300 ${headerClasses}`}>
      {/* Left: Menu Button */}
