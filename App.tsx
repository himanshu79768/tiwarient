...
const WhatsAppButton: React.FC = () => (
    <a
        href="https://wa.me/919049600466"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-50 bg-[#25D366] text-white p-3 md:py-2 md:px-4 rounded-full shadow-lg flex items-center gap-2 hover:bg-[#128C7E] transition-all duration-300 animate-fadeIn"
